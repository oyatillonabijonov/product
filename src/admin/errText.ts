const MESSAGES: Record<string, string> = {
  ...
  id_taken: 'Bu ID allaqachon band',
  ...
  sync_running: "Sinxronizatsiya allaqachon ishlayapti",
  not_configured: "Avval Billz kaliti va do'konini saqlang",
  billz_auth: "Billz javob bermadi — kalitni tekshiring",
  login_failed: "Billz kaliti noto'g'ri",
  network: "Billz bilan aloqa yo'q",
