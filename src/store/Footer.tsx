  ...
  return (
    <footer className="w-full bg-bg pt-16 pb-10 px-4 md:px-16 flex flex-col mt-auto border-t border-line/50">
      ...
      <div className="max-w-[1024px] mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-[12px] font-semibold text-primary uppercase tracking-widest mb-2">{t.footerContact}</h3>
          {config.phone && (
            <a href={`tel:${config.phone}`} className="text-[13px] text-muted hover:text-primary flex items-center gap-2 transition-colors">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-[12px] font-semibold text-primary uppercase tracking-widest mb-2">{t.footerAddress}</h3>
          <div className="text-[13px] text-muted flex items-start gap-2">
