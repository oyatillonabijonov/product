 ...
 * Fon egasining `bg_us` rasmi (`public/about/hero.webp`); qorong'i mavzuda `dark-invert` uni
 * to'q moviyga aylantiradi, shuning uchun matn oddiy tokenlar bilan ikkala mavzuda o'qiladi.
